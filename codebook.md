...
* The training and test sets are combined into one
...
* Feature names are made descriptive and tidy: the original feature names are cleaned up by making all feature name unique, '.'s are replaced with '\_' and finally trailing '\_'s are removed
